      ...
      orcamento: {
        include: {
          ...
          salas: {
            include: {
              itens: {
                include: { item: { select: { id: true, nome: true, codigo: true, descricaoComercial: true, natureza: true, valorReposicao: true, acessoriosAvulsos: { select: { nome: true, quantidade: true } } } } },
              },
            },
          },
        },
